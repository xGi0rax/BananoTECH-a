...
GiocoDaTavolo::GiocoDaTavolo(int id, string titolo, string genere, int anno, string immagine, bool disponibilita, 
    ...
    int età, string editore) : Media(id, titolo, genere, anno, immagine, disponibilita, numero_copie, in_prestito, collocazione, rating), ngiocatori(ngiocatori), durata(durata), età(età), editore(editore) {}
