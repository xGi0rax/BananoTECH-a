...
#include "../../Codice/Modello logico/Headers/XmlIO.h"
...
bool testSalvaSuFileX(){
    ...
    XmlIO xmlIO;
    string xmlFilePath = "biblioteca_testSalva.xml";

    bool salvato = xmlIO.salvaSuFile(biblioteca, xmlFilePath);
    
    ASSERT(salvato, "Errore nel salvataggio del file XML");
...
bool testCaricaDaFileX(){
    ...
    XmlIO xmlIO;
    string xmlFilePath = "biblioteca_testCarica.xml";

    bool caricato = xmlIO.caricaDaFile(biblioteca, xmlFilePath);
