#############################################################################
# Makefile for building: BananoTECH-a
# Generated by qmake (3.1) (Qt 6.8.1)
# Project:  BananoTECH-a.pro
# Template: app
# Command: C:\Qt\6.8.1\mingw_64\bin\qmake.exe -o Makefile BananoTECH-a.pro
#############################################################################
...
Makefile: BananoTECH-a.pro C:/Qt/6.8.1/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.8.1/mingw_64/mkspecs/features/spec_pre.prf \
